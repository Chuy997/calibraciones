<?php
// /var/www/html/calibraciones/aio_delete.php
    ...
    if (!$errors) {
        try {
            ...
            $hst = $pdo->prepare("
                ...
                VALUES
                  (:AioID, 'deleted', :Description, :Brand, :Model, :SerialNumber,
            ...
            $del = $pdo->prepare("DELETE FROM aio_items WHERE ID = :id");
            $del->execute([':id' => $id]);

            $pdo->commit();
            header('Location: aio_admin.php?deleted=1');
            exit;
        } catch (Throwable $e) {
...
<div class="row justify-content-center">
  <div class="col-12 col-lg-8 col-xl-6">
    ...
    <form method="POST" action="aio_delete.php" class="needs-validation" novalidate
