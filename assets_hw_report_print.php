<?php
// /var/www/html/calibraciones/assets_hw_report_print.php
...
// 1. Audit Header
$st = $pdo->prepare("SELECT * FROM assets_hw_audits WHERE AuditID = ?");
$st->execute([$id]);
$audit = $st->fetch();
...
$sqlItems = "
    ...
    JOIN assets_hw_items gi ON ai.AssetsHWID = gi.ID
    WHERE ai.AuditID = ?
    ORDER BY ai.AssetsHWID ASC
";
