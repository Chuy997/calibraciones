<?php
// /var/www/html/calibraciones/golden_view.php
...
// Consulta de materiales Golden (solo lectura)
$sql = <<<SQL
SELECT
  ID,
  Description,
...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
  <h1 class="h4 m-0">Golden – Consulta (solo lectura)</h1>
</div>
...
<div class="card p-3 table-density-comfort dt-container">
  ...
  <div class="table-wrap">
    <div class="table-scroll">
      <table class="table table-striped table-hover align-middle" id="goldenViewTable">
        <thead>
          <tr>
...
<!-- Modal imagen (misma UX que en history/golden_admin) -->
