<?php
// /var/www/html/calibraciones/ingenieria_packages.php
...
$sql = "
    ...
    FROM ingenieria_packages p
    LEFT JOIN ingenieria_items i ON i.PackageID = p.PackageID
...
<div class="d-flex justify-content-between align-items-center my-3">
    <h1 class="h3">Paquetes de Ingeniería</h1>
    <a href="ingenieria_package_create.php" class="btn btn-primary">
            ...
            <?php else: ?>
                <?php foreach ($packages as $pkg): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="ingenieria_package_view.php?id=<?= h($pkg['PackageID']) ?>" class="btn btn-sm btn-outline-primary">Ver</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
