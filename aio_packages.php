<?php
// /var/www/html/calibraciones/aio_packages.php
...
$sql = "
    ...
    FROM aio_packages p
    LEFT JOIN aio_items i ON i.PackageID = p.PackageID
...
<div class="d-flex justify-content-between align-items-center my-3">
    ...
    <a href="aio_package_create.php" class="btn btn-primary">
            ...
            <?php else: ?>
                <?php foreach ($packages as $pkg): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="aio_package_view.php?id=<?= h($pkg['PackageID']) ?>" class="btn btn-sm btn-outline-primary">Ver</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
