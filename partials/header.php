  ...
  <nav class="navbar navbar-expand-lg app-navbar border-bottom">
    <div class="container-fluid">
      <a class="navbar-brand d-flex align-items-center gap-2" href="index.php">
        ...
        <span class="fw-semibold">Argmand Instruments</span>
      </a>
      ...
      <div id="topnav" class="collapse navbar-collapse">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <?php if ($role === 'admin' || $role === 'ingenieria' || $role === 'aio'): ?>

            <!-- Dropdown AIO -->
            <?php
            $aioPages = ['aio_admin.php', 'aio_add.php', 'aio_audit.php', 'aio_update.php', 'aio_history.php', 'aio_scrap.php', 'aio_package_create.php'];
            $aioActive = in_array($current, $aioPages, true) ? 'active' : '';
            ?>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle <?= $aioActive ?>"
                href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="fa fa-building me-1"></i>AIO
              </a>
              <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item <?= active('aio_admin.php') ?>" href="aio_admin.php"><i class="fa fa-clipboard-list me-2"></i>Inventario</a></li>
                <li><a class="dropdown-item <?= active('aio_audit.php') ?>" href="aio_audit.php"><i class="fa fa-clipboard-check me-2"></i>Auditoría</a></li>
                <li><a class="dropdown-item <?= active('aio_add.php') ?>" href="aio_add.php"><i class="fa fa-plus me-2"></i>Nuevo</a></li>
                <li><a class="dropdown-item <?= active('aio_package_create.php') ?>" href="aio_package_create.php"><i class="fa fa-box-archive me-2"></i>Crear Paquete</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item <?= active('aio_scrap.php') ?>" href="aio_scrap.php"><i class="fa fa-dumpster me-2"></i>Scrap</a></li>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if ($role === 'admin'): ?>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                <li>
                  <h6 class="dropdown-header">Linpu F1200</h6>
                </li>
                ...
                <li>
                  <h6 class="dropdown-header">Mediciones</h6>
                </li>
                ...
                <li>
                  <h6 class="dropdown-header">Torques</h6>
                </li>
          ...
          <?php elseif ($role !== 'admin' && $role !== 'ingenieria' && $role !== 'aio'): ?>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li><a class="dropdown-item <?= active('aio_view.php') ?>" href="aio_view.php"><i class="fa fa-building me-2"></i>AIO</a></li>
