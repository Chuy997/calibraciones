<?php
// /var/www/html/calibraciones/assets_hw_scrap.php
  ...
  if (!$errors) {
    ...
    try {
      ...
      $hst = $pdo->prepare("
        ...
        VALUES
          (:AssetsHWID, 'scrap', :Description, :Brand, :Model, :SerialNumber,
    ...
    <?php else: ?>
      <form method="POST" action="assets_hw_scrap.php" class="needs-validation" novalidate>
        ...
        <div class="d-flex gap-2">
          <a href="assets_hw_admin.php" class="btn btn-outline-secondary">Cancelar</a>
