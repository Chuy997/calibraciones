<?php
// /var/www/html/calibraciones/ingenieria_update.php
...
// LÍMITES Y VALIDACIONES DE ARCHIVOS (igual estilo que en ingenieria_add)
...
<div class="row justify-content-center">
  <div class="col-12 col-lg-8 col-xl-7">
    ...
    <form method="POST" action="ingenieria_update.php?id=<?= h($id) ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
      ...
      <div class="row g-3">
        ...
        <div class="col-sm-6">
          ...
          <div class="form-text">
            Para dar de baja, usa <a href="ingenieria_scrap.php?id=<?= urlencode($id) ?>">Enviar a Scrap</a>.
          </div>
        </div>
