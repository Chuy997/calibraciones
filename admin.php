...
=======
    ...
    <tr>
        ...
        <th onclick="sortTable(5)">Número de Serie</th>
        <th onclick="sortTable(6)">Fecha de Calibración</th>
        <th onclick="sortTable(7)">Fecha de Vencimiento</th>
