<?php
// /var/www/html/calibraciones/ingenieria_history.php
...
$sql = "
  SELECT
    ...
    Comments,
    CreatedAt
  FROM ingenieria_history
  WHERE IngenieriaID = :id
...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
  ...
  <a href="ingenieria_admin.php" class="btn btn-outline-secondary btn-sm">
