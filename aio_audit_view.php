<?php
// /var/www/html/calibraciones/aio_audit_view.php
...
// Get Audit Header
$stmt = $pdo->prepare("SELECT * FROM aio_audits WHERE AuditID = ?");
$stmt->execute([$id]);
$audit = $stmt->fetch();
...
$stmtDetails = $pdo->prepare("
    SELECT 
        ...
        g.Location, 
        g.Picture 
    FROM aio_audit_items d
    LEFT JOIN aio_items g ON d.AioID = g.ID
    WHERE d.AuditID = ?
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="aio_audit.php" class="btn btn-outline-secondary">
                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <?php endif; ?>
                                <div>
                                    <div class="fw-bold"><?= h($item['AioID']) ?></div>
