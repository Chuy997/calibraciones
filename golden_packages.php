<?php
// /var/www/html/calibraciones/golden_packages.php
...
$sql = "
    ...
    FROM golden_packages p
    LEFT JOIN golden_items i ON i.PackageID = p.PackageID
...
<div class="d-flex justify-content-between align-items-center my-3">
    <h1 class="h3">Paquetes de Materiales</h1>
    <a href="golden_package_create.php" class="btn btn-primary">
            ...
            <?php else: ?>
                <?php foreach ($packages as $pkg): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="golden_getPackage_view.php?id=<?= h($pkg['PackageID']) ?>" class="btn btn-sm btn-outline-primary">Ver</a>
                            <!-- <a href="golden_package_label.php?id=<?= h($pkg['PackageID']) ?>" target="_blank" class="btn btn-sm btn-outline-secondary"><i class="fa fa-qrcode"></i></a> -->
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
