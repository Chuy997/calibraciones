<?php
// /var/www/html/calibraciones/assets_hw_package_label.php
...
$items = $pdo->prepare("SELECT ID, SerialNumber, Description, Brand, Model FROM assets_hw_items WHERE PackageID = :id");
$items->execute([':id' => $id]);
...
<body onload="generateQR()">
    ...
    <div class="footer">
        Sistema de Inventario (Assets HW)
    </div>
