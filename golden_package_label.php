<?php
// /var/www/html/calibraciones/golden_package_label.php
...
$items = $pdo->prepare("SELECT ID, SerialNumber, Description, Brand, Model FROM golden_items WHERE PackageID = :id");
$items->execute([':id' => $id]);
...
<head>
    ...
    <style>
        ...
        body {
            ...
            border: 1px dashed #ccc; /* Visual aid, removed in print usually via settings or kept as cut line */
