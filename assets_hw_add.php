<?php
// /var/www/html/calibraciones/assets_hw_add.php
...
function next_assets_hw_id(PDO $pdo): string {
    ...
    $n   = $max + 1;
    return sprintf('HW-%03d', $n);
}

// ID sugerido (preview en el formulario)
$suggestedId = next_assets_hw_id($pdo);
    ...
    if (!$errors) {
        try {
            ...
            $hst = $pdo->prepare("
                ...
                VALUES
                  (:AssetsHWID,'create',:Description,:Brand,:Model,:SerialNumber,:Pedimento,:Location,:Department,:Owner,:Status,:Picture,:Document,:Comments,NOW())
            ");
            $hst->execute([
              ':AssetsHWID'     => $newId,
              ':Description'  => $values['description'],
...
<div class="row justify-content-center">
  <div class="col-12 col-lg-8 col-xl-7">
    <h1 class="h4 my-3">Nuevo material Assets HW</h1>
    ...
    <form method="POST" action="assets_hw_add.php" enctype="multipart/form-data" class="needs-validation" novalidate>
      ...
      <div class="row g-3">
        ...
        <div class="col-12">
          ...
          <div class="form-text">Formato: HW-###. El valor final se confirma al guardar.</div>
        </div>
